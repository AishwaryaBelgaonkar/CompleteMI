...
.has-bg-img:after {
    content:'';
    background: url('./resources/images/6666.jpg') no-repeat center center fixed;
    position: absolute;
    top:0px;
    left: 0px;
   -webkit-background-size: cover;
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
				<div class="templatemo_product_box">
					<h1 style="font-family:Mistral;color:WHITE; font-size:100px;margin-top:-30px;margin-left:-650px;">Add Category</h1>
					<form action="cook?action=addCategory" method="post">
														<p style="width: 150%;margin-left: -300px; color:white;margin-top: 100px; padding: 20px;font-family:Lucida Calligraphy; font-weight:bold; font-size:20px;">
						...
						<table width="100%" style="margin-top: 200px; margin-left: -350px; font-size: 35px;color:white;font-family:Lucida Calligraphy;">
							...
							<tr>
								<td colspan="2" width="100%"><pre>    <b><input class="button button1" type="submit"
									value="Add" /></b></pre></td>
