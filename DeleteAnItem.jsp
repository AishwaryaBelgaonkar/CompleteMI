...
.has-bg-img:after {
    content:'';
    background: url('./resources/images/c5.jpg') no-repeat center center fixed;
    position: absolute;
    top:0px;
    left: 0px;
   -webkit-background-size: cover;
	...
	<div class="has-bg-img" style="height:900%;">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
					...
					<h1 style="font-family:Mistral;color:WHITE; font-size:100px;margin-top:-30px;margin-left:-650px;">Item to be deleted</h1>
					<form action="cook?action=deleteAnItem" method="post">
						<p
							style="width: 150%; margin-left: -250px; color: white; margin-top: 100px; padding: 20px; font-family: Lucida Calligraphy; font-weight: bold; font-size: 20px;">
							<%
						...
						<table width="100%" style="margin-top: 200px; margin-left: -350px; font-size: 35px;color:white;font-family:Lucida Calligraphy;">
						
							<tr>
								<td width="100%"><u>Item ID </u></td>
								<td><input type="text" name="name"/></td>
							</tr>
							<tr>
								<td colspan="2" width="40%"><br/><br/><input class="button button1" type="submit"
									value="DELETE" style="margin-left:150px;"/></td>
