			...
			if (action.equals("addCategory")) {
				...
				System.out.println("Delivered: "+delivered);
					if (cService.clear()) {
						...
						GlobalConstants.MESSAGE = String.format(GlobalConstants.MSG_CLEAR_SUCCESS, delivered);
					} else {
						System.out.println("Else loop");
						GlobalConstants.MESSAGE = String.format(GlobalConstants.ERROR_CLEARING, delivered);
					}
